...
def render_cmd(target: Path, quality: str, output: Path, qa_gate: bool, qa_profile: str) -> None:
    print_json(render_target(target, quality, output, qa_gate=qa_gate, qa_profile=qa_profile))
